            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between">
                                <p class="text-sm font-medium uppercase tracking-wider text-gray-500">
                                    <i class="fas fa-box-open mr-2 text-blue-500"></i> Total Product
                                </p>
                            </div>
                        ...
                        <div
                            class="rounded-xl border-l-4 border-green-600 bg-white p-6 shadow-lg transition duration-300 hover:shadow-xl">
                            <div class="flex items-center justify-between">
                                <p class="text-sm font-medium uppercase tracking-wider text-gray-500">
                                    <i class="fas fa-file-alt mr-2 text-green-500"></i> Total Articles
                                </p>
                            </div>
                            <p class="mt-2 text-2xl font-extrabold text-gray-900">
                                {{ $articles->count() ?? 0 }}
