<div class="flex flex-col w-64 bg-gray-800 text-white shadow-xl">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <a href="{{ route('products.index') }}" class="flex items-center px-4 py-2 text-sm font-medium rounded-lg transition duration-200
            ">
        ...
        <a href="{{ route('articles.index') }}" class="flex items-center px-4 py-2 text-sm font-medium rounded-lg transition duration-200
            ">
        ...
        <a href="{{ route('companyInfo.index') }}" class="flex items-center px-4 py-2 text-sm font-medium rounded-lg transition duration-200
            ">
