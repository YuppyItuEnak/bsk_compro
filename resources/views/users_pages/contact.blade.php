<x-layouts.users.layout>
    ...
    <section class="bg-blue-800 text-white py-50 text-center">
        <h1 class="text-5xl font-bold max-w-3xl mx-auto leading-tight">Hubungi Kami</h1>
        <p class="text-2xl mt-4 max-w-xl mx-auto opacity-90">Kami siap membantu Anda menemukan solusi material yang tepat
        </p>
    </section>

    <section class="max-w-screen-xl mx-auto px-5 py-16">
        <!-- Title -->
        <h2 class="text-4xl text-center font-extrabold text-blue-800 mb-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch mb-10">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white border rounded-xl shadow p-4 w-full text-left">
                    ...
                    rounded-lg flex items-center justify-center">
                        ...
                        <h3 class="text-blue-700 font-bold text-2xl">Alamat</h3>
                    </div>
                ...
                <div class="bg-white border rounded-xl shadow p-4 w-full text-left">
                    ...
                    rounded-lg flex items-center justify-center">
                        ...
                        <h3 class="text-blue-700 font-bold text-2xl">Jam Operasional</h3>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
            <div>
                <h2 class="font-bold text-2xl mb-5">Hubungi Kami</h2>
                <p>Jika Anda memiliki pertanyaan atau butuh informasi lebih lanjut, jangan ragu untuk menghubungi kami
                    melalui form di bawah ini, atau langsung melalui email atau telepon. Kami siap membantu!</p>
            </div>

            <div class="bg-white border rounded-xl shadow p-4 w-full text-left">
                <p class="font-bold text-2xl">
                    <span class="text-blue-800">PT. BSK</span> <span class="text-red-800"> Indonesia</span>
                </p>

                <p class="mb-4 text-gray-500 font-bold">
                    Berkah Sarana Karet
                </p>
