<x-layouts.users.layout>
    ...
    <section class="bg-blue-800 text-white py-50 text-center">
        <h1 class="text-5xl font-bold max-w-3xl mx-auto leading-tight">Tentang Kami</h1>
        <p class="text-2xl mt-4 max-w-xl mx-auto opacity-90">Membangun masa depan industri dengan material berkualitas
            tinggi
        </p>
    </section>

    <section class="md:max-w-screen-xl px-5 mx-auto py-16">
        <!-- Title -->
        <h2 class="text-4xl text-center font-extrabold text-blue-800 mb-5">
            Profil Perusahaan
        </h2>

        <!-- Subtitle -->
        <p class="text-gray-600 font-semibold text-center text-2xl max-w-4xl mx-auto mb-10">
            PT. Berkah Sarana Karet (BSK) Indonesia adalah perusahaan manufaktur yang bergerak di bidang produksi
            material karet dan EVA (Ethylene-Vinyl Acetate) berkualitas tinggi. Berlokasi di Dusun Kowang, Kabupaten
            Jombang, Jawa Timur, kami telah melayani berbagai industri dengan standar kualitas terbaik.
        </p>

        <p class="text-gray-600 font-semibold text-center text-2xl max-w-4xl mx-auto mb-10">
            Dengan didukung oleh tim profesional yang berpengalaman dan teknologi produksi modern, PT. BSK Indonesia
            berkomitmen untuk terus berinovasi dan memberikan solusi material terbaik yang memenuhi kebutuhan spesifik
            setiap klien kami.
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-4">
            ...
            <div class="h-full">
                <div
                    class="h-full flex flex-col bg-gradient-to-b from-blue-500 to-blue-700 border rounded-xl shadow p-6 text-left">

                    <!-- Header -->
                    <div class="flex flex-row gap-4 items-center">
                        <div class="w-10 h-10 p-1.5 bg-blue-800 rounded-lg flex items-center justify-center">
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M20.0001 23.3336C20.8842 23.3336 21.7321 22.9824 22.3573 22.3572C22.9825 21.732 23.3337 20.8841 23.3337 20C23.3337 19.1159 22.9825 18.2679 22.3573 17.6428C21.7321 17.0176 20.8842 16.6664 20.0001 16.6664C19.116 16.6664 18.2681 17.0176 17.6429 17.6428C17.0177 18.2679 16.6665 19.1159 16.6665 20C16.6665 20.8841 17.0177 21.732 17.6429 22.3572C18.2681 22.9824 19.116 23.3336 20.0001 23.3336Z"
                                    stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M35 20C35 20 30 30 20 30C10 30 5 20 5 20C5 20 10 10 20 10C30 10 35 20 35 20Z"
                                    stroke="white" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>

                        <h3 class="text-white font-bold text-2xl">Visi</h3>
                    </div>

                    <!-- Content -->
                    <p class="text-white text-base leading-relaxed mt-4">
                        Menjadi perusahaan produsen material karet dan EVA terkemuka di Indonesia yang dikenal
                        dengan kualitas produk terbaik, inovasi berkelanjutan, serta komitmen terhadap kepuasan
                        pelanggan dan kelestarian lingkungan.
                    </p>
                </div>
            </div>
            ...
            <div class="h-full">
                <div
                    class="h-full flex flex-col bg-gradient-to-b from-red-500 to-red-700 border rounded-xl shadow p-6 text-left">

                    <!-- Header -->
                    <div class="flex flex-row gap-4 items-center">
                        <div class="w-10 h-10 p-1.5 bg-red-800 rounded-lg flex items-center justify-center">
                        ...
                        <h3 class="text-white font-bold text-2xl">Misi</h3>
                    </div>

                    <ul class="mt-4 space-y-2 list-disc ml-5">
                        <li class="text-white text-base leading-relaxed">Menghasilkan produk berkualitas tinggi dengan
                            standar internasional.</li>
                        <li class="text-white text-base leading-relaxed">Memberikan layanan terbaik dan solusi yang
                            dapat disesuaikan untuk setiap klien.</li>
                        <li class="text-white text-base leading-relaxed">Berinovasi dalam teknologi dan proses produksi
                            yang berkelanjutan.</li>
                        <li class="text-white text-base leading-relaxed">Membangun kemitraan jangka panjang dengan
                            pelanggan dan para pemangku kepentingan.</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="bg-gray-100 py-12">
        <div class="max-w-6xl mx-auto px-4 text-center">
            <!-- TITLE -->
            <h2 class="text-2xl md:text-3xl font-bold text-blue-700">Nilai–Nilai Perusahaan</h2>
                    ...
                    <div class="w-12 h-12 bg-green-500 rounded-lg flex items-center justify-center">
                        <svg width="39" height="39" viewBox="0 0 39 39" fill="none"
                            ...
                            <path
                                ...
                                stroke="white" stroke-width="3.25" stroke-linecap="round" stroke-linejoin="round" />
                            <path
    ...
    <section class="md:p-16 p-10">
        <h1 class="text-blue-800 md:text-center font-bold text-3xl">
            Teknologi & Fasilitas Produksi
        </h1>

        <p class="mt-5 text-xl max-w-4xl mx-auto">
            PT. BSK Indonesia dilengkapi dengan mesin-mesin produksi berstandar
            internasional dan sistem kontrol kualitas yang ketat. Investasi berkelanjutan
            dalam teknologi memastikan kami selalu menghasilkan produk dengan presisi dan
            konsistensi terbaik.
        </p>

        <!-- Hapus text-center di sini -->
        <h1 class="text-blue-800 font-bold text-3xl md:max-w-4xl mx-auto mt-5">
            Peralatan Produksi
        </h1>

        <p class="mt-2 max-w-4xl text-xl mx-auto">
            Kami menggunakan mesin-mesin berteknologi tinggi untuk menghasilkan produk
            dengan presisi dan kualitas terbaik:
        </p>

        <div class="grid md:grid-cols-2 grid-cols-1 gap-6 mt-10 max-w-6xl mx-auto">
            <div class="border rounded-xl bg-white shadow p-6 text-left flex flex-col items-start">
                <div class="flex flex-row mb-3">
                    <div class="w-12 h-12 bg-blue-500 rounded-lg flex items-center justify-center mr-5">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <h3 class="text-blue-700 font-bold text-lg mt-3">Mixing Machine</h3>
                </div>

                <p class="text-gray-600 text-sm mt-1">
                    Mesin pencampur canggih untuk memastikan komposisi material yang homogen dan konsisten.
                </p>
            </div>
            ...
            <div class="border rounded-xl bg-white shadow p-6 text-left flex flex-col items-start">
                <div class="flex flex-row mb-3">
                    ...
                    <h3 class="text-blue-700 font-bold text-lg mt-3">Hydraulic Press</h3>
                </div>

                <p class="text-gray-600 text-sm mt-1">
                    Press hidrolik dengan tekanan tinggi untuk membentuk material sesuai spesifikasi.
                </p>
            </div>
            ...
            <div class="border rounded-xl bg-white shadow p-6 text-left flex flex-col items-start">
                <div class="flex flex-row mb-3">
                    ...
                    <h3 class="text-blue-700 font-bold text-lg mt-3">Extruder Machine</h3>
                </div>
                <p class="text-gray-600 text-sm mt-1">
                    Sistem ekstrusi modern untuk produksi sheet dan profil dengan dimensi akurat.
                </p>
            </div>
            ...
            <div class="border rounded-xl bg-white shadow p-6 text-left flex flex-col items-start">
                <div class="flex flex-row mb-3">
                    ...
                    <h3 class="text-blue-700 font-bold text-lg mt-3">Curing System</h3>
                </div>
                <p class="text-gray-600 text-sm mt-1">
                    Sistem vulkanisasi terkontrol untuk mengoptimalkan sifat mekanik material.
                </p>
            </div>
        </div>

        <h1 class="text-blue-800 font-bold text-3xl md:max-w-4xl mx-auto mt-20">
            Komitmen Lingkungan
        </h1>

        <p class="mt-2 text-xl max-w-4xl mx-auto">
            Kami berkomitmen untuk menerapkan praktik manufaktur yang ramah lingkungan, termasuk penggunaan energi
            efisien, minimalisasi limbah, dan penggunaan material yang dapat didaur ulang. Dengan pengelolaan limbah
            yang baik dan pengurangan emisi, kami berupaya memberikan kontribusi positif terhadap lingkungan.
        </p>
    </section>

    <section class="bg-blue-800 text-white py-20">
        <div class="grid md:grid-cols-2 grid-cols-1 px-10 md:px-20 gap-10">

            <!-- LEFT TEXT -->
            <div class="max-w-xl">
                <h1 class="text-5xl font-bold leading-tight">Filosofi Produksi Kami</h1>

                <p class="text-xl mt-4 opacity-90">
                    Kami percaya bahwa produk berkualitas dimulai dari pemilihan bahan baku terbaik,
                    dikombinasikan dengan proses produksi yang presisi, dan didukung oleh tim yang berdedikasi tinggi.
                </p>

                <p class="text-xl mt-4 opacity-90">
                    Setiap produk yang keluar dari fasilitas kami telah melewati kontrol kualitas ketat untuk memastikan
                    standar terbaik yang konsisten, memenuhi bahkan melampaui ekspektasi pelanggan kami.
                </p>
            </div>
            ...
            <div class="max-w-xl">
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <!-- Card 1 -->
                    <div
                        class="border rounded-xl bg-white text-black shadow p-6 flex flex-col items-center justify-center">
                        <h1 class="text-3xl font-bold">10+</h1>
                        <p class="text-sm mt-1">Tahun Pengalaman</p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-sm mt-1">Klien Puas</p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-sm mt-1">Tim Profesional</p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-sm mt-1">Kepuasan Pelanggan</p>
                    </div>
